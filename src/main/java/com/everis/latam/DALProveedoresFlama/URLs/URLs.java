package com.everis.latam.DALProveedoresFlama.URLs;

public class URLs {
	public final static String AreaInsert = "/AreaIngresar";
	public final static String AreaList = "/AreasListar";
	public final static String AreaSearch = "/AreaBuscarporId";
	...
	public final static String SolicitudInsert ="/SolicitudIngresar";
